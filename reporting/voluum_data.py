...
logging.basicConfig(level=logging.INFO, filename='yahoo_site_report.log', format=reporting.FORMAT,
                    datefmt='%d-%b-%y %H:%M:%S')
...
def extract_conversions_data(reporting_period, retrive_columns, credentials, filter_by_col=None, predicate=None):
    voluum_auth = credentials.get('voluum')
